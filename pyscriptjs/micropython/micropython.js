...
*/
        ...
        function refreshStreams() {
            ...
            if (isattys.stdout) {
                ...
                FS.createDevice('/dev', 'stdout', null, ttyout_ops.put_char.bind(undefined, undefined));
            }
            if (isattys.stderr) {
                FS.symlink('/dev/tty', '/dev/stderr');
            } else {
                FS.createDevice('/dev', 'stderr', null, ttyerr_ops.put_char.bind(undefined, undefined));
            }
        ...
        function setStdin(options) {
            ...
            if (options.stdin && options.error) {
                throw new TypeError('Both a stdin handler provided and the error argument was set');
            }
            if (options.error) {
                setStdinError();
                return;
        ...
        function setStdout(options) {
            ...
            if (!options.raw && options.isatty) {
                throw new TypeError('Cannot set isatty to true unless a raw handler is provided');
            }
            if (options.raw) {
        ...
        var ASM_CONSTS = {};
        function set_exc(tb, tblen) {
            API.python_tb = new TextDecoder().decode(HEAP8.subarray(tb, tb + tblen));
        }
        function hiwire_to_bool(val) {
            return !!Hiwire.get_value(val);
        }
        function hiwire_init_js() {
            try {
                let _hiwire = { objects: new Map(), obj_to_key: new Map(), counter: new Uint32Array([1]) };
                ...
                Hiwire.get_value = function (idval) {
                    if (!idval) {
                        API.fail_test = !!1;
                        console.error(`Pyodide internal error: Argument '${idval}' to hiwire.get_value is falsy. `);
                ...
                };
                {
                    ...
                    let buffer_datatype_map = new Map([
                        ['Int8Array', [dtypes_map['b'], 1, !!1]],
                        ['Uint8Array', [dtypes_map['B'], 1, !!1]],
                        ['Uint8ClampedArray', [dtypes_map['B'], 1, !!1]],
                        ['Int16Array', [dtypes_map['h'], 2, !!1]],
                        ['Uint16Array', [dtypes_map['H'], 2, !!1]],
                        ['Int32Array', [dtypes_map['i'], 4, !!1]],
                        ['Uint32Array', [dtypes_map['I'], 4, !!1]],
                        ['Float32Array', [dtypes_map['f'], 4, !!1]],
                        ['Float64Array', [dtypes_map['d'], 8, !!1]],
                        ['DataView', [dtypes_map['B'], 1, !!0]],
                        ['ArrayBuffer', [dtypes_map['B'], 1, !!0]],
                    ]);
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 286 in func hiwire_init_js in file "pyodide/hiwire.c"`,
                    );
        ...
        function hiwire_incref_js(idval) {
            if (idval & 1) {
                Hiwire.incref(idval);
            }
            return idval;
        ...
        function hiwire_int_js(val) {
            try {
                return Hiwire.new_value(val);
            } catch (e) {
                do {
                    console.error(
                        `EM_JS raised exception on line 318 in func hiwire_int_js in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_int_from_digits_js(digits, ndigits) {
            try {
                let result = BigInt(0);
                for (let i = 0; i < ndigits; i++) {
                    result += BigInt(HEAPU32[(digits >> 2) + i]) << BigInt(32 * i);
                }
                result += BigInt(HEAPU32[(digits >> 2) + ndigits - 1] & 0x80000000) << BigInt(1 + 32 * (ndigits - 1));
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 339 in func hiwire_int_from_digits_js in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_double_js(val) {
            try {
                return Hiwire.new_value(val);
            } catch (e) {
                do {
                    console.error(
                        `EM_JS raised exception on line 350 in func hiwire_double_js in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_string_utf8_len_js(ptr, length) {
            try {
                return Hiwire.new_value(new TextDecoder().decode(HEAP8.subarray(ptr, ptr + length)));
            } catch (e) {
                do {
                    console.error(
                        `EM_JS raised exception on line 365 in func hiwire_string_utf8_len_js in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_string_utf8_js(ptr) {
            try {
                return Hiwire.new_value(UTF8ToString(ptr));
            } catch (e) {
                do {
                    console.error(
                        `EM_JS raised exception on line 377 in func hiwire_string_utf8_js in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_call(idfunc, idargs) {
            try {
                ...
                do {
                    console.error(`EM_JS raised exception on line 408 in func hiwire_call in file "pyodide/hiwire.c"`);
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
            }
        ...
        function hiwire_call_OneArg(idfunc, idarg) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 425 in func hiwire_call_OneArg in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_call_bound_js(idfunc, idthis, idargs) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 442 in func hiwire_call_bound_js in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_HasMethod(obj_id, name) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 456 in func hiwire_HasMethod in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                return !!0;
        ...
        function hiwire_CallMethodString(idobj, name, idargs) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 474 in func hiwire_CallMethodString in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_CallMethod(idobj, name, idargs) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 482 in func hiwire_CallMethod in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_CallMethod_NoArgs(idobj, name) {
            try {
                let jsobj = Hiwire.get_value(idobj);
                let jsname = Hiwire.get_value(name);
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 488 in func hiwire_CallMethod_NoArgs in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_CallMethod_OneArg(idobj, name, idarg) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 500 in func hiwire_CallMethod_OneArg in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_construct(idobj, idargs) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 559 in func hiwire_construct in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_has_length(idobj) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 567 in func hiwire_has_length in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                return !!0;
        ...
        function hiwire_get_length_helper(idobj) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 588 in func hiwire_get_length_helper in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_get_length_string(idobj) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 602 in func hiwire_get_length_string in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_get_bool(idobj) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 674 in func hiwire_get_bool in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                return !!0;
        ...
        function hiwire_is_function_js(idobj) {
            try {
                return typeof Hiwire.get_value(idobj) === 'function';
            } catch (e) {
                do {
                    console.error(
                        `EM_JS raised exception on line 680 in func hiwire_is_function_js in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                return !!0;
        ...
        function hiwire_is_generator(idobj) {
            try {
                return getTypeTag(Hiwire.get_value(idobj)) === '[object Generator]';
            } catch (e) {
                do {
                    console.error(
                        `EM_JS raised exception on line 692 in func hiwire_is_generator in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                return !!0;
        ...
        function hiwire_is_async_generator(idobj) {
            try {
                return Object.prototype.toString.call(Hiwire.get_value(idobj)) === '[object AsyncGenerator]';
            } catch (e) {
                do {
                    console.error(
                        `EM_JS raised exception on line 698 in func hiwire_is_async_generator in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                return !!0;
        ...
        function hiwire_is_comlink_proxy(idobj) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 703 in func hiwire_is_comlink_proxy in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                return !!0;
        ...
        function hiwire_is_error(idobj) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 712 in func hiwire_is_error in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                return !!0;
        ...
        function hiwire_is_promise(idobj) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 719 in func hiwire_is_promise in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                return !!0;
        ...
        function hiwire_resolve_promise(idobj) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 727 in func hiwire_resolve_promise in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_to_string_js(idobj) {
            try {
                return Hiwire.new_value(Hiwire.get_value(idobj).toString());
            } catch (e) {
                do {
                    console.error(
                        `EM_JS raised exception on line 731 in func hiwire_to_string_js in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_constructor_name(idobj) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 745 in func hiwire_constructor_name in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_less_than(ida, idb) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 752 in func hiwire_less_than in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                return !!0;
        ...
        function hiwire_less_than_equal(ida, idb) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 753 in func hiwire_less_than_equal in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                return !!0;
        ...
        function hiwire_equal(ida, idb) {
            try {
                ...
                do {
                    console.error(`EM_JS raised exception on line 755 in func hiwire_equal in file "pyodide/hiwire.c"`);
                    console.error('Error was:', e);
                } while (0);
                return !!0;
            }
        ...
        function hiwire_not_equal(ida, idb) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 756 in func hiwire_not_equal in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                return !!0;
        ...
        function hiwire_greater_than(ida, idb) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 758 in func hiwire_greater_than in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                return !!0;
        ...
        function hiwire_greater_than_equal(ida, idb) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 759 in func hiwire_greater_than_equal in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                return !!0;
        ...
        function hiwire_reversed_iterator(idarray) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 789 in func hiwire_reversed_iterator in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_assign_to_ptr(idobj, ptr) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 794 in func hiwire_assign_to_ptr in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_assign_from_ptr(idobj, ptr) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 800 in func hiwire_assign_from_ptr in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_read_from_file(idobj, fd) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 807 in func hiwire_read_from_file in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_write_to_file(idobj, fd) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 814 in func hiwire_write_to_file in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_into_file(idobj, fd) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 823 in func hiwire_into_file in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function hiwire_subarray(idarr, start, end) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 849 in func hiwire_subarray in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsArray_Check(idobj) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 872 in func JsArray_Check in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                return !!0;
        ...
        function JsArray_New_js() {
            try {
                return Hiwire.new_value([]);
            } catch (e) {
                do {
                    console.error(
                        `EM_JS raised exception on line 877 in func JsArray_New_js in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsArray_Push_js(idarr, idval) {
            try {
                Hiwire.get_value(idarr).push(Hiwire.get_value(idval));
            } catch (e) {
                do {
                    console.error(
                        `EM_JS raised exception on line 887 in func JsArray_Push_js in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsArray_Push_unchecked_js(idarr, idval) {
            const arr = Hiwire.get_value(idarr);
            arr.push(Hiwire.get_value(idval));
            return arr.length - 1;
        }
        function JsArray_Get_js(idobj, idx) {
            try {
                let obj = Hiwire.get_value(idobj);
                let result = obj[idx];
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 916 in func JsArray_Get_js in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsArray_Set(idobj, idx, idval) {
            try {
                ...
                do {
                    console.error(`EM_JS raised exception on line 926 in func JsArray_Set in file "pyodide/hiwire.c"`);
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
            }
        ...
        function JsArray_Delete(idobj, idx) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 936 in func JsArray_Delete in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsArray_Splice(idobj, idx) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 946 in func JsArray_Splice in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsArray_slice(idobj, length, start, stop, step) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 961 in func JsArray_slice in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsArray_Clear(idobj) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 995 in func JsArray_Clear in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsObject_New_js() {
            try {
                return Hiwire.new_value({});
            } catch (e) {
                do {
                    console.error(
                        `EM_JS raised exception on line 1002 in func JsObject_New_js in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsObject_GetString_js(idobj, ptrkey) {
            try {
                let jsobj = Hiwire.get_value(idobj);
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 1018 in func JsObject_GetString_js in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsObject_SetString_js(idobj, ptrkey, idval) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 1035 in func JsObject_SetString_js in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsObject_DeleteString_js(idobj, ptrkey) {
            try {
                let jsobj = Hiwire.get_value(idobj);
                let jskey = UTF8ToString(ptrkey);
                delete jsobj[jskey];
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 1053 in func JsObject_DeleteString_js in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsObject_Dir(idobj) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 1077 in func JsObject_Dir in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsObject_Entries(idobj) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 1082 in func JsObject_Entries in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsObject_Keys(idobj) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 1087 in func JsObject_Keys in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsObject_Values(idobj) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 1092 in func JsObject_Values in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsString_InternFromCString(str) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 1099 in func JsString_InternFromCString in file "pyodide/hiwire.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsMap_New() {
            try {
                ...
                do {
                    console.error(`EM_JS raised exception on line 1115 in func JsMap_New in file "pyodide/hiwire.c"`);
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
            }
        ...
        function JsMap_Set(mapid, keyid, valueid) {
            try {
                ...
                do {
                    console.error(`EM_JS raised exception on line 1123 in func JsMap_Set in file "pyodide/hiwire.c"`);
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
            }
        ...
        function JsSet_New() {
            try {
                ...
                do {
                    console.error(`EM_JS raised exception on line 1130 in func JsSet_New in file "pyodide/hiwire.c"`);
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
            }
        ...
        function JsSet_Add(mapid, keyid) {
            try {
                ...
                do {
                    console.error(`EM_JS raised exception on line 1137 in func JsSet_Add in file "pyodide/hiwire.c"`);
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
            }
        ...
        function js2python_immutable(id) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 42 in func js2python_immutable in file "pyodide/js2python.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function js2python_js(id) {
            try {
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 53 in func js2python_js in file "pyodide/js2python.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
            ...
            try {
                {
                    ...
                    function js2python_bigint(value) {
                        ...
                        let result = _mp_obj_int_from_bytes_impl(!!0, length * 4, ptr);
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 100 in func js2python_init_js in file "pyodide/js2python.js"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsProxy_GetIter_js(idobj) {
            try {
                let jsobj = Hiwire.get_value(idobj);
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 183 in func JsProxy_GetIter_js in file "pyodide/jsproxy.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsProxy_iternext_js(idit, done_ptr, value_ptr) {
            try {
                ...
                HEAPU8[done_ptr + 0] = done;
                HEAPU32[(value_ptr >> 2) + 0] = Hiwire.new_value(value);
            } catch (e) {
                do {
                    console.error(
                        `EM_JS raised exception on line 195 in func JsProxy_iternext_js in file "pyodide/jsproxy.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function JsProxy_subscr_js(idself, idkey, idvalue, type, error) {
            try {
                ...
                if (type === 0) {
                    ...
                    if (map_like) {
                        ...
                        if (obj.has && typeof obj.has === 'function' && obj.has(key)) {
                            return HEAPU32[(_Js_undefined >> 2) + 0];
                        }
                        HEAPU32[(error >> 2) + 0] = 1;
                        return 0;
                    }
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 305 in func JsProxy_subscr_js in file "pyodide/jsproxy.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        function destroy_proxies_js(proxies_id, msg_ptr) {
            let msg = undefined;
            if (msg_ptr) {
        ...
        function pyproxy_new_js(ptrobj) {
            try {
                return Hiwire.new_value(Module.pyproxy_new(ptrobj));
            } catch (e) {
                do {
                    console.error(
                        `EM_JS raised exception on line 936 in func pyproxy_new_js in file "pyodide/pyproxy.c"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
            ...
            try {
                {
                    ...
                    Module.callPyObjectKwargs = function (ptrobj, jsargs, kwargs) {
                        ...
                        let idresult;
                        try {
                            idresult = Module.__pyproxy_apply(ptrobj, num_pos_args, num_kwargs, idargs);
                        } catch (e) {
                            API.fatal_error(e);
                            return;
                        } finally {
                    ...
                    class PyProxy {
                        ...
                        destroy(options) {
                            options = Object.assign({ message: '', destroyRoundtrip: !!1 }, options);
                    ...
                    function getPyProxyClass(flags) {
                        const FLAG_TYPE_PAIRS = [
                            [1 << 1, PySubscriptMethods],
                            [1 << 3, PyContainsMethods],
                            [1 << 8, PyCallableMethods],
                        ];
                        ...
                        descriptors.constructor = Object.getOwnPropertyDescriptor(PyProxy.prototype, 'constructor');
                    ...
                    class PyCallableMethods {
                        ...
                        callKwargs(...jsargs) {
                            ...
                            if (kwargs.constructor !== undefined && kwargs.constructor.name !== 'Object') {
                    ...
                    function pyproxy_new(ptrobj, { flags: flags_arg, cache, props, $$ } = {}) {
                        ...
                        props = Object.assign({ isBound: !!0, captureThis: !!0, boundArgs: [], roundtrip: !!0 }, props);
                ...
                do {
                    console.error(
                        `EM_JS raised exception on line 613 in func pyproxy_init_js in file "pyodide/pyproxy.js"`,
                    );
                    console.error('Error was:', e);
                } while (0);
                API.handle_js_error(e);
        ...
        /** @type {function(...*):?} */
        var _mp_sched_keyboard_interrupt = (Module['_mp_sched_keyboard_interrupt'] =
            createExportWrapper('mp_sched_keyboard_interrupt'));

        /** @type {function(...*):?} */
        var _mp_obj_int_from_bytes_impl = (Module['_mp_obj_int_from_bytes_impl'] =
            createExportWrapper('mp_obj_int_from_bytes_impl'));
...
if (typeof exports === 'object' && typeof module === 'object') module.exports = _createMicropythonModule;
else if (typeof define === 'function' && define['amd'])
    define([], function () {
        return _createMicropythonModule;
    });
else if (typeof exports === 'object') exports['_createMicropythonModule'] = _createMicropythonModule;
!(function (e, t) {
    'use strict';
    ...
    var r = ['isConstructor', 'isEval', 'isNative', 'isToplevel'],
        ...
        a = r.concat(n, i, ['args'], ['evalOrigin']);
    function o(t) {
        if (t) for (var r = 0; r < a.length; r++) void 0 !== t[a[r]] && this['set' + e(a[r])](t[a[r]]);
    }
    (o.prototype = {
        getArgs: function () {
            return this.args;
    ...
    for (var c = 0; c < n.length; c++)
        (o.prototype['get' + e(n[c])] = t(n[c])),
            (o.prototype['set' + e(n[c])] = (function (e) {
                return function (t) {
    ...
    for (var u = 0; u < i.length; u++)
        (o.prototype['get' + e(i[u])] = t(i[u])),
            (o.prototype['set' + e(i[u])] = (function (e) {
                return function (t) {
                    this[e] = String(t);
                };
            })(i[u]));
    ...
    (function (e, t) {
        ...
        'function' == typeof define && define.amd
            ...
            : 'object' == typeof exports
            ? (module.exports = t(require('stackframe')))
        ...
        return {
            ...
            parseV8OrIE: function (t) {
                return t.stack
                    ...
                    .map(function (t) {
                        ...
                        return new e({ functionName: a, fileName: o, lineNumber: i[1], columnNumber: i[2], source: t });
                    }, this);
            },
                ...
                return t.stack
                    ...
                    .map(function (t) {
                        ...
                        var r = /((.*".+"[^@]*)?[^@]*)(?:@)/,
                            n = t.match(r),
                            i = n && n[1] ? n[1] : void 0,
                            a = this.extractLocation(t.replace(r, ''));
                        return new e({
                            functionName: i,
                            fileName: a[0],
                            lineNumber: a[1],
            ...
            parseOpera9: function (t) {
                for (
                    var r = /Line (\d+).*script (?:in )?(\S+)/i, n = t.message.split('\n'), i = [], a = 2, o = n.length;
                    a < o;
                    a += 2
                ) {
                    var s = r.exec(n[a]);
                    s && i.push(new e({ fileName: s[2], lineNumber: s[1], source: n[a] }));
                }
                return i;
            },
            parseOpera10: function (t) {
                for (
                    ...
                    var s = r.exec(n[a]);
                    s &&
                        i.push(new e({ functionName: s[3] || void 0, fileName: s[2], lineNumber: s[1], source: n[a] }));
                }
                return i;
            },
...
async function loadMicroPython(options) {
    ...
    let { heapsize, indexURL, stdin, stdout, stderr } = Object.assign({ heapsize: 1024 * 1024 }, options);
    ...
    bootstrap_runPython('def register_js_module(name, mod): sys.modules[name] = mod');
