...
["_mp_js_init","_mp_js_init_repl","_mp_js_do_str","_mp_js_process_char","_mp_hal_get_interrupt_char","_mp_sched_keyboard_interrupt","_malloc","_free","_mp_js_do_exec","_mp_js_do_import","_mp_js_register_js_module","_mp_obj_jsobj_callback_proxy","_proxy_c_init","_proxy_c_to_js_call","_proxy_c_to_js_lookup_attr","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
function js_subscr_store(f_ref,idx,value) { proxy_js_ref[f_ref][convert_mp_to_js_obj_jsside(idx)] = convert_mp_to_js_obj_jsside(value); }
